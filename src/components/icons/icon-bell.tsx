...
const BellSVG: React.FC<React.SVGProps<SVGSVGElement>> = (props) => {
  return (
    <svg {...props} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" transform="rotate(-45)">
...
export const BellIcon = (props: React.ComponentProps<typeof Icon>) => <Icon component={BellSVG} {...props} />;
