...
const DiscountProductSVG: React.FC<React.SVGProps<SVGSVGElement>> = (props) => {
  return (
    <svg
      fill="#000000"
      height="200px"
    ...
    >
      ...
      <g id="SVGRepo_iconCarrier">
        ...
        <g>
          ...
          <g>
            {" "}
            <path d="M280.492,337.085c-2.541,0-4.802,1.13-5.931,3.53l-49.571,101.827c-0.424,0.848-0.706,1.836-0.706,2.684 c0,3.531,3.107,7.485,7.909,7.485c2.684,0,5.366-1.413,6.356-3.53l49.713-101.827c0.422-0.848,0.564-1.837,0.564-2.684 C288.824,340.051,284.445,337.085,280.492,337.085z"></path>{" "}
          </g>{" "}
        </g>{" "}
      </g>
    </svg>
...
export const DiscountProductIcon = (
  props: React.ComponentProps<typeof Icon>
) => <Icon component={DiscountProductSVG} {...props} />;
