            ...
            <Col span={10}>
              <Col span={24}>
                <Flex gap="middle" justify="space-between" align="center">
                  ...
                  <Title level={5}>{moneyFormatter.format(totalPrice)}</Title>
                </Flex>
              </Col>
              <Col span={24}>
                <Flex gap="middle" justify="space-between" align="center">
                  ...
                  <Title level={5}>{moneyFormatter.format(0)}</Title>
                </Flex>
              </Col>
              <Col span={24}>
                <Flex gap="middle" justify="space-between" align="center">
                  ...
                  <Title level={5} style={{ color: `${token.colorPrimary}` }}>
                    {moneyFormatter.format(shippingMoney)}
                  </Title>
                </Flex>
              </Col>
              <Col span={24}>
                <Flex gap="middle" justify="space-between" align="center">
                  ...
                  <Title level={5} style={{ color: `${token.colorPrimary}` }}>
                    {moneyFormatter.format(totalPrice + shippingMoney)}
                  </Title>
                </Flex>
              </Col>
            </Col>
              ...
              <Row gutter={[16, 24]}>
                ...
                <Col span={24}>
                  <Flex gap="middle" justify="space-between" align="center">
                    ...
                    <Text strong>{moneyFormatter.format(0)}</Text>
                  </Flex>
                </Col>
                <Col span={24}>
                  <Flex gap="middle" justify="space-between" align="center">
                    ...
                    <Text strong>{moneyFormatter.format(change)}</Text>
                  </Flex>
                </Col>
